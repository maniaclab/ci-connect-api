...
#define log_info(msg) \
do{ std::cout << "INFO: " << msg << std::endl; }while(0)

///Log that an error or problem has occurred to stderr
#define log_warn(msg) \
do{ std::cerr << "WARNING: " << msg << std::endl; }while(0)
...
do{ \
	...
	str << msg; \
	std::cerr << "FATAL: " << str.str() << std::endl; \
	throw std::runtime_error(str.str()); \
}while(0)

#endif //CONNECT_LOGGING_H
